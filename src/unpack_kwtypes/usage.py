...
if TYPE_CHECKING:
    # src/unpack_kwtypes/usage.py:15: note: Revealed type is "def (**kwargs: Any) -> typing.Coroutine[Any, Any, builtins.list[TypedDict('unpack_kwtypes.source.Movie', {'title': builtins.str, 'year': builtins.int})]]"
